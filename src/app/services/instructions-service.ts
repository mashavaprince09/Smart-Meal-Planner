...
export class InstructionsService {
  ...
  instructionsResponseTest: InstructionsResponse[] = [
    {
      "name": "",
      "steps": [
        {
  ...
  getInstructionsTest(instructionsRequest: InstructionsRequest): Observable<InstructionsResponse[]> {
    return of(this.instructionsResponseTest);
  }

  getInstructions(instructionsRequest: InstructionsRequest): Observable<InstructionsResponse[]> {
    const url = `${environment.apiBaseUrls.spoonacular}/recipes/${instructionsRequest.id}/analyzedInstructions`;
    console.log('InstructionsService getInstructions', url);
    return this.httpClient.get<InstructionsResponse[]>(url, {
      params: {
        apiKey: environment.apiKeys.spoonacular,
        stepBreakdown: instructionsRequest.stepBreakdown
      }
    });
  }
